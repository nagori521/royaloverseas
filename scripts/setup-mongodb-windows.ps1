...
if (-not $hasMongod) {
  ...
  $argsSilent = @( "/i", $msiPath, "/qn", "ADDLOCAL=all", "INSTALLLOCATION=C:\Program Files\MongoDB\Server\$MongoVersion", "SERVICE=1" )
  try {
    ...
    $argsUi = @( "/i", $msiPath, "/qb", "ADDLOCAL=all", "INSTALLLOCATION=C:\Program Files\MongoDB\Server\$MongoVersion", "SERVICE=1" )
